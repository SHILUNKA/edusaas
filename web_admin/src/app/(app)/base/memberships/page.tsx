        ...
        <div className="p-6 max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                ...
                <div className="flex gap-3">
                    <Link href="/base/participants/new">
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow flex flex-col h-full group">
            ...
            <div className="p-5 flex items-start gap-4 border-b border-gray-50">
                ...
                <Link href={`/base/memberships/${customer.id}`} className="text-gray-300 hover:text-indigo-600 p-1 rounded-full hover:bg-indigo-50 transition-colors opacity-0 group-hover:opacity-100">
            ...
            <div className="p-3 bg-gray-50 border-t border-gray-100 grid grid-cols-2 gap-2">
                <Link href={`/base/participants/new?parent=${customer.id}`} className="flex items-center justify-center gap-1 text-xs font-medium text-gray-600 hover:text-indigo-600 hover:bg-white py-2 rounded border border-transparent hover:border-gray-200 transition-all">
                    <Plus size={14} /> 添加学员
                </Link>
                <button 
