...
export default function SchedulePage() {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-80px)] bg-gradient-to-br from-white to-slate-50/30 rounded-3xl shadow-lg shadow-slate-200/40 border border-slate-100 overflow-hidden backdrop-blur-sm">

            {/* Header - Soft UI */}
            <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100 bg-gradient-to-r from-slate-50 to-gray-50 z-20">
                <div className="flex items-center gap-6">
                    <h1 className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent flex items-center gap-2.5">
                    ...
                    <div className="flex items-center bg-gradient-to-r from-slate-100 to-gray-100 rounded-2xl p-1.5 border border-slate-200 shadow-inner">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 bg-white border-2 border-indigo-200 text-indigo-700 px-5 py-2.5 rounded-2xl hover:bg-indigo-50 hover:border-indigo-300 shadow-sm transition-all hover:shadow-md font-bold"
                    >
