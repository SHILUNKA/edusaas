/*
 * 校区管理: 学员运营中心 (V18.0 - Soft UI Evolution)
 * 路径: /base/students
...
// Soft UI Components
import { SoftPageContainer, SoftHeader, SoftButton, SoftCard, SoftBadge } from '@/components/ui/SoftUI';
...
export default function CampusStudentsPage() {
    ...
    return (
        <SoftPageContainer>
            <SoftHeader
                title="学员运营"
                subtitle={`总在读: ${students.length} 人 | 需续费: ${students.filter(s => (s.remaining_counts || 0) < 3).length} 人`}
                icon={<GraduationCap size={32} style={{ color: SOFT_COLORS.softPink }} />}
                variant="pink"
                action={
                    <SoftButton
                        variant="pink"
            ...
            <SoftCard variant="white" padding="sm">
                <div className="flex justify-between items-center">
                    ...
                    <div className="text-sm flex items-center gap-2" style={{ color: SOFT_COLORS.textMuted }}>
